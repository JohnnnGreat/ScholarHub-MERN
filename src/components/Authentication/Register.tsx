...
import ResearchType from "../Onboarding/ResearchType";
        ...
        <div>
          ...
          >
            ...
            >
              <Input
                type="text"
                className="w-[100%] mx-[auto !important] text-[#76ABAE] py-4 px-5 rounded-full placeholder:text-[#ffffffa1] border bg-transparent hover:bg-transparent focus:bg-transparent invalid:bg-transparent border-[#ffffff59] "
