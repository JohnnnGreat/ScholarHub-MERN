...
const SingleResourceComponent = ({
  ...
  return (
    <>
      ...
      <div className="w-full p-[.8rem] mt-[5.5rem]">
        <div className="max-w-[1100px] mx-auto">
          <div className="flex flex-wrap gap-[.9rem]">
            <div className="bg-[#76abae41] text-[14px] font-semibold rounded-[10px] text-[#95dbdfce] py-[.8rem] px-[1.1rem]">
              {resInfo?.privacy?.toUpperCase()}
            </div>
            <div className="bg-[#6f6f6f52] text-[14px] rounded-[10px] font-semibold text-[#ffffffc0] py-[.8rem] px-[1.1rem]">
              {resInfo?.subjectArea?.toUpperCase()}
            </div>
          </div>
          <h1 className="text-white text-[50px] golden-font mt-[.8rem]">{resInfo?.title}</h1>
          {resInfo?.parentOrganization && <p>{resInfo?.parentOrganization}</p>}
          <div className="flex items-center">
            <div className="flex-1">
              ...
              <div className="flex gap-3 mt-[1rem] items-center">
          ...
          {resInfo?.privacy === "public" ? (
            <Button
              ...
              // className="bg-[#76abae41] text-[14px] font-semibold rounded-[10px] text-[#95dbdfce] py-[.8rem] px-[1.1rem]"
            >
              Download
            </Button>
          ) : (
            <Button
              ...
              className="bg-[#76abae41] my-[.8rem] text-[14px] font-semibold rounded-[10px] text-[#95dbdfce] py-[.8rem] px-[1.1rem]"
            >
